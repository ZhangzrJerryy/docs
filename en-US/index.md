...
development:
  ...
  desc: Koishi offers a wide range of professional features for developers, enabling them to build scalable solutions for various complex requirements.
advantages:
  - 
    title: TypeScript supporting
    desc: Koishi is entirely built on TypeScript, providing top-tier type support. The rich code hints allow you to write code without even needing to refer to the documentation.
    link: /
    icon:
  ...
  - 
    ...
    desc: Explore our meticulously crafted documentation to learn everything from getting started as a beginner to developing plugins.
    link: /
    icon:
      viewBox: 0 0 448 512
